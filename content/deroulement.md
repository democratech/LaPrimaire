...
Nous précisons également qu'une connexion internet ou mobile est requise afin de participer à LaPrimaire.org. Vous pouvez, au choix, soit vous connecter à l'adresse [https://web.laprimaire.org](https://web.laprimaire.org), soit télécharger l'application desktop ou mobile dédiée (l"'Application"). Il sera ainsi possible de participer à LaPrimaire.org au moyen de tous supports existants (desktop : PC/MAC/Linux, Mac OS, Web-browser ; mobile : iOS, Android, Windows Mobile).

Toutes les informations relatives à LaPrimaire.org sont disponibles sur le site web accessible à l'adresse [https://laprimaire.org](https://laprimaire.org) (le "Site Web").
...
Un soutien se matérialise par le fait pour un participant à LaPrimaire.org d'avoir soutenu le citoyen concerné comme candidat au sein de l'Application.
...
- l'indication du fait si le candidat est un citoyen plébiscité ou bien s'il s'est un candidat officiellement déclaré. 
...
Du point de vue des candidat(e)s, chaque candidature est soumise au vote des participants à LaPrimaire.org un nombre de fois statistiquement identique. Du point de vue des participants, ils devront se prononcer sur un ou plusieurs lots de candidat(e)s, qui leur sera(ont) adressé(s) de manière totalement aléatoire.

Au sein de chaque lot, le système de vote appelé [« le jugement majoritaire »](https://www.youtube.com/watch?v=ODuPoepQ1tY) sera utilisé. Les participants pourront se prononcer sur tous les candidat(e)s de manière précise en leur attribuant une mention : <i>Très Bien</i>, <i>Bien</i>, <i>Assez Bien</i>, <i>Passable</i>, <i>Insuffisant</i>, <i>à Rejeter</i> (le "Système de Vote"). Chaque candidat(e) sera attribué(e) sa « mention-majoritaire », la mention soutenue par une majorité des votants contre toute autre mention. Le classement des candidats est alors déterminé par leur mentions-majoritaires.

A l’issue de la pré-sélection les cinq (5) candidats ayant les meilleures mentions-majoritaires seront qualifiés (pourvu qu’elles ne sont pas <i>à Rejeter</i>).
...
Le vote final destiné à choisir entre les candidat(e)s finalistes est conduit selon le jugement majoritaire. Chaque participant pourra donc se prononcer sur chacun des finalistes en lui attribuant une mention.
Le candidat vainqueur (le “Candidat Citoyen”) sera celle ou celui qui aura obtenu la meilleure mention-majoritaire. Quand deux candidats ont la même mention-majoritaire, il y a deux ensembles de votant en désaccord pour chacun, ceux pour une mention-majoritaire plus élevé et ceux pour une mention-majoritaire moins élevé. Le plus grand ensemble des quatre décide : s’il est pour une mention plus élevé, ce candidat est vainqueur ; s’il est pour une mention moins élevé, ce candidat est perdant. 
