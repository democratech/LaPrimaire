...
### 1er mai 2016 : Arrêté de la liste provisoire des candidats qualifiés
...
L'un de nos objectifs est donc de permettre à toute personne de s'exprimer et à toutes les idées de pouvoir être exprimées, sous réserve du respect de la Charte et des principes fondamentaux et valeurs présidant notre République. Pour cela, nous entendons permettre à tous les citoyens de s'impliquer tout au long du déroulement de la Primaire Ouverte et proposerons donc des outils issus de l'intelligence collective et favorisant la démocratie participative.

Au cours de cette période, chaque candidat pré-qualifié devra ainsi compléter la Présentation mise en ligne, selon un format pré-défini, comprenant notamment les éléments suivants :
- sa biographie ;
...
Concrètement, les candidats qualifés seront répartis par lots de candidats de manière totalement aléatoire, c'est à dire que chaque lot sera différent s'agissant à la fois de :
...
Au cours de cette période, nous permettrons à tous les citoyens de s'impliquer et proposerons des outils issus de l'intelligence collective et favorisant la démocratie participative.
...
- approval voting : chaque participant vote pour ou contre chacun des candidats. Le candidat vainqueur est celui ayant obtenu le  plus grand nombre de votes favorables.
...
- de recueillir les 500 parrainages nécessaires à la validation de sa candidature à l'élection présidentielle ;
