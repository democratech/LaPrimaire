...
En se basant sur des simulations de vote, nous avons estim\'e le nombre minimum d'\'electeurs n\'ecessaires pour assurer la fiabilit\'e. de  notre syst\`eme de vote. % la repr\'esentativit\'e et l'\'equir\'epartie
\end{abstract}
...
\input{\rootPath Parts/mv}
\input{\rootPath Parts/mj}

\input{\rootPath Parts/laprimaire}
